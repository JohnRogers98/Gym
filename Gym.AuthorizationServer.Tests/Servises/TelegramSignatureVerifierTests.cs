...
namespace Gym.Infrastructure.Tests.Telegram
{
    public class TelegramSignatureVerifierTests
    {
        ...
        public void Verify_That_Init_Data_Hash_Are_Valid()
        {
            ...
            var botToken = new TelegramBotToken(Environment.GetEnvironmentVariable("DOTNET_TG_BOT_TOKEN")!);

            TelegramSignatureVerifier sut = new(botToken);
            ...
            Assert.Equal(5265776755, result.Value!.Id);
        }
