...
{
    [Route("api/admin-calendar-events/{id}/actions/cancel")]
    [ApiController]
    ...
    {
        [HttpPost]
        public async Task<ActionResult<CancelCalendarEventResponse>> CancelCalendarEvent(String id)
        {
            CancelCalendarEventResult cancelCalendarEventResult = await _mediator.Send(new CancelCalendarEvent(id));
