namespace Gym.Infrastructure.Configurations
{
    ...
    public sealed record CollectionOptions(String Instructors, String Trainings, String CalendarEvents, String Users, String Clients)
    {
        public static CollectionOptions Default => new CollectionOptions("instructors", "trainings", "calendar-events", "users", "clients");
    }
}
