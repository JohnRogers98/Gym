...
{
    [ApiController]
    public class ListClientsForInstructorEndpoint(IHttpClientFactory _httpClientFactory, IOptions<WebApiOptions> _webApiOptioons) : ControllerBase
    {
        [HttpGet("api/instructor-clients")]
        public async Task<IActionResult> HandleAsync(CancellationToken cancellationToken)
        {
            ...
            using var proxyRequestMessage = await this.CreateProxyRequestAsync("/api/instructor-clients", cancellationToken: cancellationToken);
