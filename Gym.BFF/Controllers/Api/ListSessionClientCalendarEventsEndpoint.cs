...
{
    [ApiController]
    public class ListSessionClientCalendarEventsEndpoint(IHttpClientFactory _httpClientFactory, IOptions<WebApiOptions> _webApiOptions) : ControllerBase
    {
        ...
        public async Task<IActionResult> HandleAsync(CancellationToken cancellationToken)
        {
            ...
            using var proxyRequestMessage = await this.CreateProxyRequestAsync("api/clients/me/client-calendar-events", cancellationToken: cancellationToken);
