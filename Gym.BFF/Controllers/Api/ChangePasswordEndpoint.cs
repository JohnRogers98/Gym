...
{
    [ApiController]
    public class ChangePasswordEndpoint(IHttpClientFactory _httpClientFactory, IOptions<AuthorizationServerAdminApiOptions> _adminApiOptions) : ControllerBase
    {
        ...
        public async Task<IActionResult> HandleAsync(CancellationToken cancellationToken)
        {
            ...
            using var proxyRequestMessage = await this.CreateProxyRequestAsync("api/users/change-password", cancellationToken: cancellationToken);
